...
public abstract class WeaponUpgrade extends Consumable{
    ...
    public static class DmgUpgrade extends WeaponUpgrade{
        ...
        public DmgUpgrade(double dam, ShootingMode s){
            super("Dmg upgrade", 16, 16, new Bullet(0,0,0,0,0, null), s, null);
            switch(s){
                ...
                case MISSILE: color = new Color(243, 5+(int)(5*dam), 8);     imprint.damage += dam*4; break;
            }
        }
    ...
    public static class SpdUpgrade extends WeaponUpgrade{
        ...
        public SpdUpgrade(double v, ShootingMode s){
            super("Spd upgrade", 16, 16, new Bullet(0,0,0,0,0, null), s, null);
            switch(s){
                ...
                case MISSILE: color = new Color(243, 5+(int)(5*v), 8);     imprint.bulletSpeed += 0.05*v; break;
            }
        }
    ...
    public static class RldUpgrade extends WeaponUpgrade{
        ...
        public RldUpgrade(double v, ShootingMode s){
            super("Rld upgrade", 16, 16, new Bullet(0,0,0,0,0, null), s, null);
            switch(s){
                ...
                case MISSILE: color = new Color(243, 5+(int)(5*v), 8);     imprint.reloadSpeed += 0.035*v; break;
            }
        }
    ...
    public static class ColUpgrade extends WeaponUpgrade{
        ...
        public ColUpgrade(double v, ShootingMode s){
            super("Col upgrade", 16, 16, new Bullet(0,0,0,0,0, null), s, null);
            switch(s){
                ...
                case MISSILE: color = new Color(243, 5+(int)(5*v), 38);     imprint.bulletHeat -= 0.04*v; break;
            }
        }
    ...
    public static class AmoUpgrade extends WeaponUpgrade{
        ...
        public AmoUpgrade(ShootingMode s){
            super("Amo upgrade", 16, 16, new Bullet(0,0,0,0,0, null), 1, s, null);
            switch(s){
